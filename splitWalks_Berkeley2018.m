...
for ww = 1:length(walks)
    ...
    thisWalk.rEye_norm_pos_x = rEye_pupRadius(walks(ww,1): walks(ww,2),:);
    thisWalk.lEye_norm_pos_x = lEye_pupRadius(walks(ww,1): walks(ww,2),:);
    ...
    %%
            [ testrGazeGroundIntersection] = calcGroundFixations( thisWalk.rHeelXYZ, thisWalk.lHeelXYZ, thisWalk.rGazeXYZ, thisWalk.rEyeballCenterXYZ);
            [ testlGazeGroundIntersection] = calcGroundFixations( thisWalk.rHeelXYZ, thisWalk.lHeelXYZ, thisWalk.lGazeXYZ, thisWalk.lEyeballCenterXYZ);
