...
for ss = 1:length(hs)-1
    ...
    for fr = hs(ss):hs(ss+1)-1
        ...
        for mm = 1:length(shadowMarkerNames)
           shadowFixed_fr_mar_dim(fr:end,mm, 1) = shadowFixed_fr_mar_dim(fr:end,mm, 1) + slippageXYZ(1);
           shadowFixed_fr_mar_dim(fr:end,mm, 2) = shadowFixed_fr_mar_dim(fr:end,mm, 2) + slippageXYZ(2);
           shadowFixed_fr_mar_dim(fr:end,mm, 3) = shadowFixed_fr_mar_dim(fr:end,mm, 3) + slippageXYZ(3);
