...
%         plot3([hx headVecZ_fr_xyz(fr,1)], [hy headVecZ_fr_xyz(fr,2)], [hz headVecZ_fr_xyz(fr,3)],'c.-','LineWidth',2)
        ...
        eyeVelScale = 100;
        evx = eyeVelXYZ(fr,1)*eyeVelScale;
        evy = eyeVelXYZ(fr,2)*eyeVelScale;
        evz = eyeVelXYZ(fr,3)*eyeVelScale;
        
        ev1 = quiver3(ex,ey,ez,evx,evy,evz);
        ev1.Color = 'y';
        ev1.LineWidth = 3;
        ...
        s1 = surface(groundPlane_x , groundPlane_y, groundPlane_z, groundPlane_color  );
        s1.LineStyle = 'none';
        s1.FaceColor = 'interp';
